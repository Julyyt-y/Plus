package com.example.appla.plus.View;
...
public class PersonalItemView extends LinearLayout {
    ...
    public PersonalItemView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PersonalItemView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        inflate = LayoutInflater.from(context).inflate(R.layout.item_personal_menu, this, false);
